                ...
                <Container>
                    ...
                    <Grid container mt = { 8 }>
                        ...
                        <Grid item md = { 4 } xs = { 3 } >
                            ...
                            <Typography variant='h6' >
                                Same day funding,<br /> when we receive all funding <br /> documents before 11:00 AM CST.
                            </Typography>
                        </Grid>
                        ...
                        <Grid item md = { 4 } xs = { 3 } >
                            ...
                            <Typography variant='h6' >
                            All online funding process available. <br /> Use your phone, tablet, or laptop to complete the application. It is that easy.
                            </Typography>
                        </Grid>
